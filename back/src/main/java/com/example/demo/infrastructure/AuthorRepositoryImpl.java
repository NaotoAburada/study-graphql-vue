...
public class AuthorRepositoryImpl implements AuthorRepository {
    ...
    @Override
    public List<Author> getAuthorByName(Name name) {
        return authorFactory.create(authorMapper.getAuthorByName(name.getValue()));
    }

    @Override
    public List<Author> getAuthorByMultiConditions(Id id, Name name) {
        return authorFactory.create(authorMapper.getAuthorByMultiConditions(id.getValue(), name.getValue()));
    }
